  ...
  return (
    <div className="space-y-6 p-6">
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold tracking-tight">Live Intelligence Dashboard</h1>
          <p className="text-muted-foreground">
            Real-time analytics and insights for visa processing operations
          </p>
        </div>
        ...
        <TabsContent value="processing" className="space-y-4">
          <Card className="p-6">
            ...
            <CardContent className="px-0 pt-6">
              <p className="text-gray-500">Detailed processing metrics are being developed. Check back soon for updates.</p>
            </CardContent>
          </Card>
        </TabsContent>

...
// This would typically be in a separate metadata config file in app/knowledgebase/layout.tsx
// for Next.js app router, but shown here for reference
export const metadata: Metadata = {
  title: 'UK Visa Knowledge Assistant | Immigration Support',
  description: 'Get accurate information about UK visa types, requirements, and application procedures.',
};

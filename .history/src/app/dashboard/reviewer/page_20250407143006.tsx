    ...
    <div className="flex h-screen bg-gray-50">
      ...
      <div className="flex-1 overflow-auto">
        ...
        <div className="p-6">
         ...
         {/* AI Scan Results - Enhanced Visual Section */}
<div className="mb-6">
  <Card className="overflow-hidden">
    <CardHeader className="bg-gradient-to-r from-blue-50 to-indigo-50 border-b">
      <div className="flex justify-between items-center">
        ...
        <div className="flex items-center space-x-2">
          <Badge className="bg-amber-100 text-amber-800">
            ...
            {scanResult.issues.length} Issues Found
          </Badge>
      ...
      <CardDescription>
        Scan completed on {scanResult.scanCompletedAt?.toLocaleString()} • {Math.round((scanResult.scanCompletedAt - scanResult.scanStartedAt) / 1000)} seconds
      </CardDescription>
    </CardHeader>
    ...
    <CardContent className="pt-6">
      ...
      <div className="grid grid-cols-4 gap-4 mb-6">
        <div className="bg-blue-50 rounded-lg p-4 text-center">
          <div className="text-sm text-blue-700 mb-1">Overall Score</div>
          <div className="text-3xl font-bold text-blue-700">{scanResult.score}/100</div>
          <div className="mt-2">
        ...
        <div className="bg-green-50 rounded-lg p-4 text-center">
          <div className="text-sm text-green-700 mb-1">Rootedness Score</div>
          <div className="text-3xl font-bold text-green-700">84/100</div>
          <div className="mt-2">
        ...
        <div className="bg-purple-50 rounded-lg p-4 text-center">
          <div className="text-sm text-purple-700 mb-1">Intent Analysis</div>
          <div className="text-3xl font-bold text-purple-700">76/100</div>
          <div className="mt-2">
        ...
        <div className="bg-amber-50 rounded-lg p-4 text-center">
          <div className="text-sm text-amber-700 mb-1">Risk Level</div>
          <div className="text-3xl font-bold text-amber-700">MEDIUM</div>
      ...
      {/* Security Checks */}
      <div className="mb-6">
        <h3 className="text-md font-medium mb-3">Security & Validation Checks</h3>
        <div className="grid grid-cols-3 gap-4">
          <div className="flex items-center p-3 bg-green-50 border border-green-100 rounded-md">
            <div className="h-8 w-8 mr-3 bg-green-100 rounded-full flex items-center justify-center">
              <CheckCircle2 className="h-5 w-5 text-green-600" />
            </div>
            <div>
              <p className="font-medium text-green-800">Passport Validated</p>
              <p className="text-xs text-green-600">Document appears genuine</p>
            </div>
          </div>
          ...
          <div className="flex items-center p-3 bg-green-50 border border-green-100 rounded-md">
            ...
            <div>
              <p className="font-medium text-green-800">INTERPOL Check</p>
              <p className="text-xs text-green-600">No matches found</p>
            </div>
          </div>
          ...
          <div className="flex items-center p-3 bg-green-50 border border-green-100 rounded-md">
            ...
            <div>
              <p className="font-medium text-green-800">Sanctions List</p>
              <p className="text-xs text-green-600">No matches found</p>
            </div>
          </div>
          ...
          <div className="flex items-center p-3 bg-green-50 border border-green-100 rounded-md">
            ...
            <div>
              <p className="font-medium text-green-800">KYC Verification</p>
          ...
          <div className="flex items-center p-3 bg-amber-50 border border-amber-100 rounded-md">
            <div className="h-8 w-8 mr-3 bg-amber-100 rounded-full flex items-center justify-center">
              <AlertCircle className="h-5 w-5 text-amber-600" />
            </div>
            <div>
              <p className="font-medium text-amber-800">Visa History</p>
              <p className="text-xs text-amber-600">Multiple short stays detected</p>
            </div>
          </div>
          ...
          <div className="flex items-center p-3 bg-green-50 border border-green-100 rounded-md">
            ...
            <div>
              <p className="font-medium text-green-800">Financial Check</p>
              <p className="text-xs text-green-600">Sufficient funds verified</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <Tabs defaultValue="issues">
          ...
          <div className="space-y-3">
            {scanResult.issues.length > 0 ? (
              scanResult.issues.map((issue, index) => (
                ...
                >
                  <div className={`
                    h-8 w-8 mr-3 rounded-full flex items-center justify-center flex-shrink-0
                    ${issue.severity === 'critical' || issue.severity === 'high' ? 'bg-red-100' : 
              ...
              <div className="text-center py-8 text-gray-500">
                ...
                <p>No issues detected in this application</p>
              </div>
            )}
          </div>
        </TabsContent>
              ...
              scanResult.recommendations.map((rec, index) => (
                <div key={index} className="p-4 bg-blue-50 border border-blue-100 rounded-md">
                  <div className="flex">
                    ...
                    <div>
                      <p className="font-medium text-blue-900 mb-1">{rec.message}</p>
                      <div className="flex space-x-2 mt-2">
                        <Badge className="bg-blue-100 text-blue-800">
                          {rec.actionType.replace('_', ' ').toUpperCase()}
                        </Badge>
                        {rec.relatedIssueIds.length > 0 && (
                          <Badge variant="outline" className="text-xs">
                            {rec.relatedIssueIds.length} related {rec.relatedIssueIds.length === 1 ? 'issue' : 'issues'}
                          </Badge>
                        )}
                      </div>
                      {rec.actionType !== 'verify' && (
                        <Button size="sm" variant="outline" className="mt-3 bg-white">
                          <ExternalLink className="h-3 w-3 mr-1" />
                          {rec.actionType === 'update' ? 'Update Information' : 
                           rec.actionType === 'upload' ? 'Upload Document' :
                           rec.actionType === 'contact_support' ? 'Contact Support' : 
                           rec.actionType === 'resubmit' ? 'Request Resubmission' : 'Take Action'}
                        </Button>
                      )}
                    </div>
                  </div>
        ...
        <TabsContent value="analysis">
          <div className="space-y-6">
            <div>
              <h4 className="font-medium mb-3">Travel Pattern Analysis</h4>
              <div className="p-4 bg-gray-50 border rounded-md">
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <p className="text-sm text-gray-500">Previous Visa Applications</p>
                    <p className="font-medium">3 in the last 24 months</p>
                  </div>
                  <div>
                    <p className="text-sm text-gray-500">Average Stay Duration</p>
                    <p className="font-medium">14 days</p>
                  </div>
                  <div>
                    <p className="text-sm text-gray-500">Return Rate</p>
                    <p className="font-medium">100% (All previous visas respected)</p>
                  </div>
                  <div>
                    <p className="text-sm text-gray-500">Travel Purpose Pattern</p>
                    <p className="font-medium">Tourism (3), Business (0)</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div>
              <h4 className="font-medium mb-3">Document Consistency Check</h4>
              <div className="p-4 bg-gray-50 border rounded-md">
                <div className="space-y-3">
                  <div className="flex items-center">
                    ...
                    <div>
                      <p className="font-medium">Photo matches across all documents</p>
                      <p className="text-sm text-gray-500">Biometric verification passed</p>
                    </div>
                  </div>
                  <div className="flex items-center">
                    <div className="w-6 h-6 mr-2 flex-shrink-0">
                    ...
                    <div>
                      <p className="font-medium">Name format inconsistency detected</p>
                      <p className="text-sm text-gray-500">Minor variations in name format</p>
                    </div>
                  </div>
                  <div className="flex items-center">
                    <div className="w-6 h-6 mr-2 flex-shrink-0">
                    ...
                    <div>
                      <p className="font-medium">Address consistent across all documents</p>
            ...
            <div>
              <h4 className="font-medium mb-3">Financial Assessment</h4>
              <div className="p-4 bg-gray-50 border rounded-md">
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <p className="text-sm text-gray-500">Required Funds</p>
                  ...
                  <div>
                    <p className="text-sm text-gray-500">Fund Stability</p>
                ...
                <div className="mt-3">
                  <div className="w-full bg-gray-200 rounded-full h-2.5">
                    <div className="bg-green-500 h-2.5 rounded-full" style={{ width: '166%' }}></div>
                  </div>
                  <div className="flex justify-between text-xs mt-1">
                    <span>Required</span>
                    <span className="text-green-600">166% of required amount</span>
                  </div>
                </div>
              </div>
            </div>

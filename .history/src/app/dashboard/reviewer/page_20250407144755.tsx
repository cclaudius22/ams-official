...
<nav className="space-y-1">
  <a href="#" className="flex items-center p-2 border-l-2 border-blue-600 text-blue-600 pl-3">
    <span>My Queue</span>
    <span className="ml-auto bg-gray-100 text-gray-800 px-2 py-0.5 rounded text-xs">23</span>
  </a>
  <a href="#" className="flex items-center p-2 text-gray-700 hover:text-blue-600 pl-3 hover:border-l-2 hover:border-blue-600">
    <span>Pending Reviews</span>
    <span className="ml-auto bg-gray-100 text-gray-800 px-2 py-0.5 rounded text-xs">12</span>
  </a>
  <a href="#" className="flex items-center p-2 text-gray-700 hover:text-blue-600 pl-3 hover:border-l-2 hover:border-blue-600">
    <span>Completed</span>
  </a>
  <a href="#" className="flex items-center p-2 text-gray-700 hover:text-blue-600 pl-3 hover:border-l-2 hover:border-blue-600">
    ...
    <span className="ml-auto bg-gray-100 text-red-600 px-2 py-0.5 rounded text-xs">3</span>
  </a>
</nav>
...
<nav className="space-y-1">
  ...
  <a href="#" className="flex items-center p-2 text-gray-700 hover:text-blue-600 pl-3 hover:border-l-2 hover:border-blue-600">
    <span>Messages</span>
    <span className="ml-auto bg-gray-100 text-blue-600 px-2 py-0.5 rounded text-xs">4</span>
  </a>
</nav>
        </div>
      </div>

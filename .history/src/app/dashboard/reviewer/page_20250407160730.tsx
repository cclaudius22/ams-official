...
export default function OfficialReviewPage() {
  ...
  //     setIsLoading(true);
  //     try {
  //       const appId = 'VK-2503-HPI-HD0'; // Would come from route params
  //       const appData = await getApplication(appId);
  //       const scanData = await getAIScanResult(appId);
  ...
  const submitFinalDecision = async () => {
    ...
    try {
      ...
      // await updateApplicationStatus(applicationData.applicationId, {
      //   status: finalDecision === 'approve' ? 'approved' : 'referred',
      //   decisions,
      //   notes
      // });
...
<div className="space-y-6">
  {/* Section Group - Identity & Background */}
  <div className="bg-white rounded-lg shadow-sm p-4 border border-gray-100">
    <h2 className="text-base font-medium text-gray-700 mb-3">Identity & Background</h2>
  ...
  {/* Section Group - Eligibility & Travel */}
  <div className="bg-white rounded-lg shadow-sm p-4 border border-gray-100">
    <h2 className="text-base font-medium text-gray-700 mb-3">Eligibility & Travel</h2>
    <div className="space-y-4">

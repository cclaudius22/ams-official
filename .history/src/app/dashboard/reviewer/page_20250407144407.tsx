    ...
    <div className="flex h-screen bg-gray-50">
      ...
      <div className="w-64 bg-white border-r">
        <div className="p-4">
          ...
          {/* Left Sidebar - Professional Style */}
<div className="w-64 bg-white border-r h-full">
  <div className="p-5">
    <div className="flex items-center space-x-3 mb-8">
      <div className="h-8 w-8 bg-blue-600 rounded flex items-center justify-center text-white font-medium">
        RJ
      </div>
      <div>
        <h3 className="font-medium">Rachel Johnson</h3>
        <p className="text-sm text-gray-600">Senior Visa Officer</p>
      </div>
    </div>

    {/* Main Navigation - No Icons */}
    <div className="mb-6">
      <a href="#" className="block py-2 font-medium text-blue-600 border-l-2 border-blue-600 pl-3">
        My Queue
        <span className="float-right bg-gray-100 text-gray-800 px-2 py-0.5 text-xs rounded">23</span>
      </a>
      <a href="#" className="block py-2 text-gray-700 hover:text-blue-600 pl-3 hover:border-l-2 hover:border-blue-600">
        Pending Reviews
        <span className="float-right bg-gray-100 text-gray-800 px-2 py-0.5 text-xs rounded">12</span>
      </a>
      <a href="#" className="block py-2 text-gray-700 hover:text-blue-600 pl-3 hover:border-l-2 hover:border-blue-600">
        Completed
      </a>
      <a href="#" className="block py-2 text-gray-700 hover:text-blue-600 pl-3 hover:border-l-2 hover:border-blue-600">
        Escalated Cases
        <span className="float-right bg-gray-100 text-red-600 px-2 py-0.5 text-xs rounded">3</span>
      </a>
    </div>

    <div className="my-6 border-t" />

    {/* Tools Section - No Icons */}
    ...
    {/* Team Section - No Icons */}
    <h3 className="text-xs font-medium text-gray-500 uppercase tracking-wider mb-3">Team</h3>
    <div>
      <a href="#" className="block py-2 text-gray-700 hover:text-blue-600 pl-3 hover:border-l-2 hover:border-blue-600">
        Office Team
      </a>
      <a href="#" className="block py-2 text-gray-700 hover:text-blue-600 pl-3 hover:border-l-2 hover:border-blue-600">
        Messages
        <span className="float-right bg-gray-100 text-blue-600 px-2 py-0.5 text-xs rounded">4</span>
      </a>
    </div>

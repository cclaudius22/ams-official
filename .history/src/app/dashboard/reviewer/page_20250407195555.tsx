...
import {
  ...
  GraduationCap, Library, Languages, BookOpen, // Icons for student sections
  ArrowLeft, Bell, MessageSquare, Eye, Download
} from 'lucide-react'
...
export default function OfficialReviewPage() {
  ...
  const sectionDefinitions = useMemo(() => ({
    ...
    // professional: { title: 'Professional Information', icon: <Briefcase className="h-5 w-5 text-orange-500" /> }, // Optional

    ...
    <div className="flex h-screen bg-gray-50">
      ...
      <div className="flex-1 overflow-auto">
        ...
        <div className="p-6">
          ...
          {/* AI Scan Results */}
          <Card className={`mb-6 border-l-4 ${riskLevel.bgColor} border-l-${riskLevel.color.split('-')[1]}-500`}>
            <CardHeader>
              <div className="flex justify-between items-start">
                <div className="flex items-center">
                ...
                <Badge className={`${riskLevel.bgColor} ${riskLevel.color}`}>
                  {riskLevel.level} Risk ({scanResult.score}/100)
                </Badge>
              </div>
              <CardDescription>
                Automated analysis completed on {scanResult.scanCompletedAt?.toLocaleString()}
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-4">

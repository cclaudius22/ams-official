...
import { mockApplicationData } from '@/lib/mockdata' // Fix casing
import { mockScanResult } from '@/lib/mockdata' // Fix casing
      ...
      <div className="flex-1 overflow-auto">
        ...
        <div className="p-6">
          ...
          <div className="space-y-6">
            {/* --- DEBUGGING --- */}
            {console.log('Debugging sections:', applicationData.sections), null} 
            {/* --- END DEBUGGING --- */}

  ...
  return (
    <>
      <div className="space-y-6">
       ...
       {/* AI Scan Results */}
        {/* Ensure scanResult is loaded before rendering */}
        {scanResult ? (
           ...
           // --- Replace the comment with null or a proper element ---
           null // Render nothing if scanResult is not ready
           // Or: <div className="p-4 text-center border rounded bg-gray-50 text-gray-500">Loading AI Scan Results...</div>
           // --- End of fix ---
        )}

// src/app/dashboard/reviewer/livequeue/page.tsx
'use client'
...
import LiveMetricsSection from '@/components/dashboard/LiveMetricsSection' // Import the new metrics component
...
export default function LiveQueuePage() {
  ...
  const [showMetrics, setShowMetrics] = useState(false); // Toggle for metrics section

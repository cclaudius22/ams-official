...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    // Prompt including instructions to prioritize context but use general knowledge and provide links
...
6.  **Format Clearly:** Use Markdown for formatting like bold text (\`**bold**\`) and headings (\`### Heading\`), paragraphs, bullet points, or numbered lists for readability.

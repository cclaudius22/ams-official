...
export const mockApplicationData: ApplicationData = {
  ...
  sections: {
    ...
    travelInsurance: {
      status: 'complete',
      validationStatus: 'success', // Or 'pending' if verification needed
      data: {
          ...
          startDate: '2025-05-30', // Usually starts just before travel
          endDate: '2025-08-01',   // Usually ends just after travel
          durationDays: 64,      // Calculate if needed, or store
          keyCoverages: ['emergency_medical', 'repatriation', 'lost_luggage'], // Example coverages
          notes: 'Policy meets standard requirements for Schengen area, but verify specific country needs.', // Optional notes
          insuranceDocument: {
              type: 'insurance_policy',
              fileUrl: 'https://placehold.co/400x500/png?text=Insurance+Policy',
              fileName: 'allianz_policy_jjdoe.pdf',
              uploadedAt: '2025-04-06T11:15:00Z', // Assuming upload time
              verificationStatus: 'verified',
              verifiedAt: '2025-04-06T11:20:00Z' // Assuming verification time
          },
          completedAt: '2025-04-06T11:25:00Z'
      },
      updatedAt: '2025-04-06T11:25:00Z'
  },
  // Represents required documents not tied to a specific section above
  documents: {
    status: 'pending_upload', // Example status
    validationStatus: 'pending',
    data: {
        sectionId: 'documents',
        // List of documents required for this visa type / applicant context
        requiredDocumentsList: [
            {
                docType: 'birth_certificate',
                docTypeName: 'Birth Certificate (Original or Certified Copy)', // More descriptive name
                status: 'uploaded', // 'required', 'uploaded', 'verified', 'missing', 'rejected'
                notes: 'Uploaded copy seems clear.', // Optional review notes
                uploadedDocument: {
                    type: 'birth_certificate',
                    fileUrl: 'https://placehold.co/400x500/png?text=Birth+Certificate',
                    fileName: 'birth_cert_jjdoe.pdf',
                    uploadedAt: '2025-04-07T09:30:00Z',
                    verificationStatus: 'pending',
                    verifiedAt: null
                }
            },
            {
                docType: 'police_clearance_certificate',
                docTypeName: 'Police Clearance Certificate (Home Country)',
                status: 'required', // Example: Still needed
                notes: 'Must be issued within the last 6 months.',
                uploadedDocument: null // Not uploaded yet
            },
            {
                docType: 'police_clearance_certificate_residence',
                docTypeName: 'Police Clearance Certificate (Country of Residence > 1 yr)',
                status: 'not_required', // Example: Applicant hasn't lived elsewhere long enough
                notes: 'Applicant resided in UK < 5 years.',
                uploadedDocument: null
            },
             {
                docType: 'tuberculosis_test_certificate',
                docTypeName: 'Tuberculosis (TB) Test Certificate',
                status: 'uploaded',
                notes: 'Certificate from approved clinic.',
                uploadedDocument: {
                    type: 'tb_test_certificate',
                    fileUrl: 'https://placehold.co/400x500/png?text=TB+Test',
                    fileName: 'tb_test_clinic_london.pdf',
                    uploadedAt: '2025-04-07T09:35:00Z',
                    verificationStatus: 'verified',
                    verifiedAt: '2025-04-07T10:00:00Z'
                }
            }
        ],
        completedAt: null // Section not fully complete yet
    },
    updatedAt: '2025-04-07T09:35:00Z' // Last upload time
},
...
study: {
  ...
  data: {
      ...
      institutionAddress: 'Gower St, London WC1E 6BT, United Kingdom',
      courseName: 'MSc Data Science and Machine Learning',
      courseLevel: 'Postgraduate (RQF Level 7)', // UK NQF/RQF levels often used
      ...
      tuitionFees: {
          amount: 28500,
          currency: 'GBP',
          paymentStatus: 'deposit_paid', // 'full_paid', 'deposit_paid', 'pending'
          amountPaid: 5000, // Example deposit amount
          paymentDueDate: '2025-08-01'
      },
      completedAt: '2025-04-05T10:00:00Z' // When student filled this info
  },
...
// --- NEW: CAS Section ---
cas: {
  status: 'verified', // Assuming CAS number checked against DB
  validationStatus: 'success', // But AI issue raised about expiry
  data: {
      sectionId: 'cas',
      casNumber: 'E123456789GBXYZ0', // Example format
      casStatus: 'assigned', // 'assigned', 'used', 'withdrawn', 'expired'
      casIssueDate: '2025-04-01',
      casExpiryDate: '2025-09-15', // Example: Expires shortly before course start
      sponsorLicenseNumber: 'AB12CD345', // University's sponsor license
      isATASRequired: false, // Academic Technology Approval Scheme
      atasCertificateNumber: null, // If required
      verificationChecks: {
          casNumberVerified: true,
          institutionMatch: true,
          courseMatch: true,
          verificationMethod: 'internal_database_check',
          verificationDate: '2025-04-05T11:00:00Z'
      },
      completedAt: '2025-04-05T10:05:00Z' // When student entered CAS no.
  },
  updatedAt: '2025-04-05T11:00:00Z'
},

// --- NEW: English Proficiency Section ---
englishProficiency: {
  status: 'complete',
  validationStatus: 'success', // Data present, but AI flags score issue
  data: {
      sectionId: 'englishProficiency',
      testType: 'IELTS Academic', // 'IELTS Academic', 'TOEFL iBT', 'PTE Academic', etc.
      testDate: '2025-03-10',
      testReportFormNumber: '123456-7890-ABC', // TRF Number for IELTS
      overallScore: 6.0, // Example: Meets overall, but not component
      componentScores: {
          listening: 6.5,
          reading: 6.5,
          writing: 5.5, // Example: Below requirement
          speaking: 6.0
      },
      requiredScores: { // Store requirements if known
          overall: 6.5,
          minimumComponent: 6.0
      },
      document: {
          type: 'english_test_report',
          fileUrl: 'https://placehold.co/400x500/png?text=IELTS+Report',
          fileName: 'ielts_report_jjdoe.pdf',
          uploadedAt: '2025-04-05T10:15:00Z',
          verificationStatus: 'verified', // Verified doc authenticity
          verifiedAt: '2025-04-05T11:30:00Z'
      },
      completedAt: '2025-04-05T10:20:00Z'
  },
  updatedAt: '2025-04-05T11:30:00Z'
},

// --- NEW: Academic Qualifications Section ---
// Separated from 'professional' for student context
academicQualifications: {
  ...
  data: {
      ...
      qualifications: [
          {
              type: 'degree',
              level: 'Undergraduate (RQF Level 6)',
              name: 'BSc Computer Science',
              institution: 'University of California, Berkeley',
              country: 'USA',
              yearCompleted: 2023,
              gradeOrResult: 'GPA 3.8/4.0',
              specialization: 'Software Engineering',
              document: {
                  type: 'degree_certificate',
                  fileUrl: 'https://placehold.co/400x500/png?text=BSc+Cert',
                  fileName: 'bsc_ucb_cert.pdf',
                  uploadedAt: '2025-04-04T15:00:00Z',
                  verificationStatus: 'verified'
              }
          },
           {
              type: 'transcript',
              level: 'Undergraduate (RQF Level 6)',
              name: 'Academic Transcript - BSc Computer Science',
              institution: 'University of California, Berkeley',
              country: 'USA',
              yearCompleted: 2023, // Or date issued
              document: {
                  type: 'academic_transcript',
                  fileUrl: 'https://placehold.co/400x500/png?text=BSc+Transcript',
                  fileName: 'bsc_ucb_transcript.pdf',
                  uploadedAt: '2025-04-04T15:05:00Z',
                  verificationStatus: 'verified'
              }
          }
          // Add High School / A-Levels etc. if needed
      ],
...
} // End of sections object
}; // End of mockApplicationData
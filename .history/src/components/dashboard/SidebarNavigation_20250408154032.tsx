...
const NavLink: React.FC<NavLinkProps> = ({ 
  ...
  return (
    <Link href={href} className={`flex items-center p-1.5 pl-3 text-sm ${activeClass}`}>
      <span>{children}</span>
      {badge && (
    ...
    <div className="w-64 bg-white border-r h-screen overflow-y-auto">
      <div className="p-4">
        ...
        <NavSection title="Live Dashboard" icon="/icons/data.svg">
          <NavLink href="/src/app/dashboard/livequeue">Live Queue</NavLink>
          <NavLink href="/src/app/dashboard/live-intelligence">Live Intelligence</NavLink>
        </NavSection>
        ...
        <NavSection title="Visa Processing" icon="/icons/visa.svg">
          <NavLink href="#" active={true} badge="23">My Queue</NavLink>
        ...
        <NavSection title="Tools & Integrations" icon="/public/icons/integrations.svg">
          <NavLink href="#">Verification Tools</NavLink>
          <NavLink href="#">Visa Base</NavLink>
          <NavLink href="#">AI Tools</NavLink>
          <NavLink href="#">API Databases</NavLink>
          <NavLink href="#">Security Checks</NavLink>
          <NavLink href="#">Recent Updates</NavLink>

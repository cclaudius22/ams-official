                        ...
                        <Card className={cn(cardBg, cardBorder)}>
                            ...
                            <CardContent>
                                ...
                                <ResponsiveBar
                                    ...
                                    padding={0.4}  // Increased padding for more spacing
                                    layout="horizontal"
                                    valueScale={{ type: 'linear' }}
                                    colors={['#8b5cf6']}  // Base violet color
                                    ...
                                    defs={[
                                        {
                                            ...
                                            colors: [
                                                ...
                                                { offset: 100, color: '#6d28d9' }, // violet-700
                                            ],
                                        },
                                        {
                                            id: 'dots',
                                    ...
                                    onMouseEnter={(data, e) => {
                                        ...
                                        e.target.style.transition = 'opacity 200ms';
                                    }}
                                    onMouseLeave={(data, e) => {

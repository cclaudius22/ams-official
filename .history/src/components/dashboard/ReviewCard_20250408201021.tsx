    ...
    <div className="border-b border-gray-200 relative">
      ...
      <div className="pl-6 pr-4 pt-6 pb-2">
        ...
        <div className="grid grid-cols-3 gap-6 mb-4">
          {/* Applicant info */}
          <div>
            <h3 className="text-gray-600 text-lg mb-1">Applicant</h3>
            <p className="font-semibold text-xl mb-1">{review.applicant}</p>
            <p className="text-gray-500">{review.type} • {review.country}</p>
          </div>
          
          {/* Risk Score */}
          <div>
            <h3 className="text-gray-600 text-lg mb-1">Risk Score</h3>
            <p className={`font-semibold text-xl ${riskDisplay.color}`}>
              {riskDisplay.text}
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              <h3 className="text-gray-600 text-lg mb-1">SLA Remaining</h3>
              <p className="font-semibold text-xl text-orange-500">{review.slaRemaining}</p>
            </div>
            
            <div>
              <h3 className="text-gray-600 text-lg mb-1">AI Recommendation</h3>
              <p className="font-semibold text-xl">{review.aiRecommendation}</p>
            </div>
          </div>
        </div>

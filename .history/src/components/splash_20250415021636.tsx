...
const messages = [
  {
    ...
    description: "Leverage artificial intelligence for faster, more accurate processing and risk assessment.",
    bgColor: "from-[#4f46e5] to-[#3730a3]" 
  },
  {
    id: 2,
    title: "Streamline officals onboarding with nexus onboarding engine",
  ...
  },
  {
    ...
    description: "Utilise our visa builder to create and deploy new visa categories quickly.",

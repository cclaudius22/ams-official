...
// --- FIX: Define navItems BEFORE useState that uses it ---
...
const Sidebar: React.FC = () => {
  ...
  // Initialize open sections based on active path - Now navItems is defined
  const [openSections, setOpenSections] = useState<Record<string, boolean>>(() => {
    const initialOpenState: Record<string, boolean> = {};
    // Iterate over the defined navItems array
        ...
        return (
          <div key={item.label} className="px-3 py-1"> {/* Adjusted padding for parent */}
            ...
            <div
              ...
              // Estimate max height for smooth transition - adjust multiplier if needed

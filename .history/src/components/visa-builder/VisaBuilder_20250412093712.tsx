 ...
 const removeDocumentExample = (docId: string, index: number) => {
  ...
  return (
    <VisaBuilderContext.Provider value={contextValue}>
     ...
     {/* Main Content Grid - Different layout for Step 3 */}
     <div className={`grid grid-cols-1 ${currentStep === 3 ? 'lg:grid-cols-2' : 'lg:grid-cols-3'} gap-6 items-start`}>
        {/* Left Column: Basic Info + Summary (or AI Scan Info for Step 3) */}
        <div className={`${currentStep === 3 ? 'lg:col-span-1' : 'lg:col-span-1'} space-y-6`}>
           ...
           {/* Configuration Summary - Only show when not on Step 3 */}
           {currentStep !== 3 && (
           ...
           {/* Show AI Scan Info Card when on Step 3 */}
           {currentStep === 3 && (
           ...
           {currentStep !== 3 && (
             <div className="mt-4 text-sm text-purple-600">
               ...
               >
                 <ShieldCheck className="h-4 w-4 mr-2" />
                 Check AI Scanner Documentation
               </a>
             </div>
           )}
          </div>
        ...
        <div className={`${currentStep === 3 ? 'lg:col-span-1' : 'lg:col-span-2'} space-y-6`}>
          {currentStep === 1 && (
            <VisaBuilderStep1
              fixedStages={fixedStagesData}
              conditionalStages={conditionalStages}
          ...
          {currentStep === 3 && (
            <>
              {/* AI Scan Configurator */}
              <AIScanConfigurator
                aiScans={aiScans}
                toggleAIScan={toggleAIScan}
              />

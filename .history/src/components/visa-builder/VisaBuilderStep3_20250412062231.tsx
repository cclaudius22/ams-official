...
import ConfigurationSummary, { ConfigurationSummaryProps } from "./ConfigurationSummary";
import useVisaBuilderStore from "./VisaBuilder";
...
interface VisaConfig {
  // Define the visa configuration interface based on your actual data structure
  id?: string;
  name: string;
  description: string;
  stages: Array<{
...
export function VisaBuilderStep3() {
  const { visaConfig } = useVisaBuilderStore();

...
const VisaBuilderStep2: React.FC<VisaBuilderStep2Props> = ({
  ...
  const addProcessingTier = () => {
    setProcessingTiers([...processingTiers, { type: '', timeframe: '' }]);
  };
  ...
  return (
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          <CardTitle className="flex items-center"><DollarSign className="h-5 w-5 mr-2 text-green-600"/>Visa Costs</CardTitle>
        </CardHeader>

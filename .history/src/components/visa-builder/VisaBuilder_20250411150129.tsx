...
import {
  ...
  Image, FileText, Building, CheckSquare, RotateCcw, Save, Activity // Added Activity as placeholder
} from 'lucide-react';
// -----------------------------------------
...
import { Stage, DocumentType } from './interfaces'; // Ensure this import is correct

// --- CORRECTED STAGE DATA ARRAY DEFINITIONS ---

const fixedStagesData: Stage[] = [
    // Icons are assigned the component itself (e.g., CheckSquare), not a string.
...
const conditionalStagesData: Stage[] = [
    ...
    { id: 'MEDICAL_WORKER_INFO', name: 'Medical Worker Info', icon: User, enabled: false, group: 'conditional', categories: ['Medical'] }, // Changed icon to User as example

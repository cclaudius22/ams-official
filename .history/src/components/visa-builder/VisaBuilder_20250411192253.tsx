...
const defaultAdditionalCost = { description: '', amount: '', currency: 'GBP' };
...
const VisaBuilder: React.FC = () => {
 ...
 const removeDocumentExample = (docId: string, index: number) => {
  ...
  const handleSaveConfiguration = () => {
    ...
    // Add any final validation for Step 2 fields if needed here
  ...
  return (
    <div className="flex flex-col space-y-6">
      ...
      <div className="flex flex-wrap justify-between items-center border-b pb-4 mb-4 gap-2">
        ...
        {/* Save button is only shown on Step 2 */}
        {/* {currentStep === 2 && (
        ...
        <div className="lg:col-span-2 space-y-6">
          {currentStep === 1 && (
            <VisaBuilderStep1
              ...
              onNextStep={handleNextStep} // Pass navigation handler
            />
          )}
           {currentStep === 2 && (
             <VisaBuilderStep2
               ...
               onPreviousStep={handlePreviousStep} // Pass navigation handler
               onSave={handleSaveConfiguration} // Pass FINAL save handler
             />
          )}
        </div>
      </div>

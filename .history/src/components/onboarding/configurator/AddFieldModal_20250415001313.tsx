...
const getDefaultDataType = (fieldType: FieldType | 'heading'): string => {
  switch (fieldType) {
    ...
    case 'infoBlock':
    case 'heading':
      return 'string'; // These are display-only fields
    default:
      return 'string';
  }
};
...
const AddFieldModal: React.FC<AddFieldModalProps> = ({
  ...
  const [fieldType, setFieldType] = useState<FieldType | 'heading'>('text');
      ...
      <DialogContent className="sm:max-w-[500px]">
        ...
        <div className="grid gap-4 py-4">
          <div className="space-y-2">
            ...
            <Select
              value={fieldType}
              onValueChange={(value: FieldType | 'heading') => setFieldType(value)}
            >

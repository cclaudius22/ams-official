...
const SortableStepItem: React.FC<SortableStepItemProps> = ({ step, isActive }) => {
  ...
  const getStatusIndicator = () => {
    if (isEmpty) {
      return (
        <div className="h-5 w-4 rounded-full bg-amber-50 border border-amber-200 flex items-center justify-center">
    ...
    return (
      <div className="h-5 w-4 rounded-full bg-emerald-50 border border-emerald-200 flex items-center justify-center">

            ...
            <div className="px-6 pt-4 pb-0 border-b bg-background shadow-sm">
              <div className="flex items-center justify-between max-w-screen-2xl mx-auto w-full">
                <TabsList className="h-12">
                  <TabsTrigger value="details" className="flex items-center gap-2 px-4 h-10">
                    <Settings className="h-4 w-4" />
                    <span>Configuration Details</span>
                  </TabsTrigger>
                  <TabsTrigger value="builder" className="flex items-center gap-2 px-4 h-10">
                    <Layers className="h-4 w-4" />
                    <span>Form Builder</span>
                  </TabsTrigger>
                  <TabsTrigger value="preview" className="flex items-center gap-2 px-4 h-10">

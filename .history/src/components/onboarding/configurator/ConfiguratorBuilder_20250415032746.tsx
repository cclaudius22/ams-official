            ...
            <div className="flex-1 overflow-hidden">
              ...
              <TabsContent value="builder" className="h-full p-0 m-0 overflow-hidden">
                ...
                <div className="grid grid-cols-12 gap-0 h-full">
                  {/* Minimal Steps List */}
                  <div className="col-span-12 md:col-span-1 border-r bg-white overflow-y-auto">
                    <div className="p-1 sticky top-0 bg-card z-10 border-b">
                      <h2 className="font-medium text-xs truncate">Steps</h2>
                    </div>
                    <div className="p-1">
                      <StepsListPanel />
                    </div>
                  ...
                  {/* Maximized Step Editor */}
                  <div className="col-span-12 md:col-span-8 border-r bg-white overflow-y-auto">
                    <StepEditorPanel

    ...
    steps: [
      {
        ...
        order: 0,
        fields: [
            { id: `field-sample-${id}-1`, fieldType: 'text', label: 'Full Name', fieldName: 'fullName', isRequired: true, order: 0 },
            { id: `field-sample-${id}-2`, fieldType: 'email', label: 'Work Email', fieldName: 'workEmail', isRequired: true, order: 1, placeholder: 'Enter work email' },
        ]
      },
      {
        id: sampleStepId2,
            ...
            <div className="flex-1 overflow-hidden">
              ...
              <TabsContent value="builder" className="h-full p-0 m-0 overflow-hidden">
                ...
                <div className="grid grid-cols-12 gap-0 h-full">
                  ...
                  {/* Step Editor - Slightly reduced width */}
                  ...
                  {/* Component Library */}
                  <div className="col-span-12 md:col-span-3 bg-white overflow-y-auto">

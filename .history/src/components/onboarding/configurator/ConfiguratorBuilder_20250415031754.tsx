            ...
            <div className="flex-1 overflow-hidden">
              ...
              <TabsContent value="builder" className="h-full p-0 m-0 overflow-hidden">
                ...
                <div className="grid grid-cols-12 gap-0 h-full">
                  ...
                  <div className="col-span-12 md:col-span-3 border-r bg-white overflow-y-auto">
                    <div className="p-5 sticky top-0 bg-card z-10 border-b">
                      <h2 className="font-medium text-lg">Add and Organize Steps</h2>
                      <p className="text-sm text-muted-foreground mt-1">Build your form by adding and arranging steps</p>
                    </div>
                    <div className="p-4">
                      <StepsListPanel />
                    </div>
                  ...
                  <div className="col-span-12 md:col-span-7 border-r bg-white overflow-y-auto">
                    <div className="p-5 sticky top-0 bg-white z-10 border-b">
                  ...
                  <div className="col-span-12 md:col-span-3 bg-white overflow-y-auto relative">
                    <div className="p-5 sticky top-0 bg-white z-20 border-b">
                      <h2 className="font-medium text-lg">Component Library</h2>
                      <p className="text-sm text-muted-foreground mt-1">Add pre built formfields onto your form</p>
                    </div>
                    <div className="p-4">

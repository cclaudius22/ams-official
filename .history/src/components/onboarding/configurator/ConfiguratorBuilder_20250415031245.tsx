            ...
            <div className="flex-1 overflow-hidden">
              ...
              <TabsContent value="builder" className="h-full p-0 m-0 overflow-hidden">
                ...
                <div className="grid grid-cols-12 gap-0 h-full">
                  ...
                  <div className="col-span-12 md:col-span-2 border-r bg-white overflow-y-auto">
                    <div className="p-5 sticky top-0 bg-card z-10 border-b">
                      <h2 className="font-medium text-lg">Add Steps</h2>
                      <p className="text-sm text-muted-foreground mt-1">Add and organise your form steps</p>
                    </div>
                    <div className="p-4">
                      <StepsListPanel />
                    </div>

  ...
  <TabsList className="grid w-full grid-cols-2 gap-2 bg-transparent p-0 h-auto mb-4">
    <TabsTrigger
      ...
      className={cn(
        ...
        // Inactive styles
        "border border-input bg-background hover:bg-accent/10 hover:text-accent-foreground h-9 px-3 py-2",
        "text-muted-foreground",
        // Active state - more subtle styling with lighter colors
        "data-[state=active]:bg-blue-50 data-[state=active]:text-blue-600 data-[state=active]:shadow-sm data-[state=active]:border-blue-200"
      )}
    >

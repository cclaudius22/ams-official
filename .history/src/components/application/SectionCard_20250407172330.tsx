        ...
        <div>
          ...
          <div className="grid grid-cols-2 gap-3">
            <div className="p-2 bg-white rounded-md border border-gray-200">
              ...
              <p className="text-sm">{data.verificationTimestamp ? new Date(data.verificationTimestamp).toLocaleString() : 'N/A'}</p>
            </div>
            <div className="p-2 bg-white rounded-md border border-gray-200">
              <p className="text-xs text-gray-500">Verification Completed</p>
              <p className="text-sm">{data.verificationCompletedTimestamp ? new Date(data.verificationCompletedTimestamp).toLocaleString() : 'N/A'}</p>
            </div>

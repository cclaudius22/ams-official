...
const renderResidencySection = (data) => {
  ...
  // Professional section render function for SectionCard
const renderProfessionalSection = (data) => {
    return (
      <div className="space-y-5">
            ...
            <div className="flex flex-col space-y-4">
              <div className="flex justify-between">
                <div>
                  ...
                  <p className="text-xs text-gray-500">
                    {data.startDate ? `Since ${new Date(data.startDate).toLocaleDateString()}` : ''} 
                    {data.yearsInRole ? ` (${data.yearsInRole} years)` : ''}
                  </p>
                </div>
        ...
        <div>
          ...
          <div className="grid grid-cols-1 gap-2">
            {data.employmentDocuments?.map((doc, index) => (
        ...
        {data.verificationChecks && (
          <div>
            ...
            <div className="p-3 bg-white rounded-md border border-gray-200">
              ...
              <p className="text-xs text-gray-500">
                Verified on: {data.verificationChecks.verificationDate ? new Date(data.verificationChecks.verificationDate).toLocaleString() : 'N/A'}
              </p>

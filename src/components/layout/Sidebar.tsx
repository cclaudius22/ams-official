...
const navItems: NavItem[] = [
    ...
    },
    {
      label: 'Visa Builder', icon: Wrench, isActive: checkActive, href: '/visa-builder', subItems: [
        { href: '/visa-builder/tool', label: 'Visa Builder Tool', icon: Wrench, isActive: checkActive },
...
const Sidebar: React.FC = () => {
  ...
  const renderNavItems = (items: NavItem[], isSubmenu = false) => {
    return items.map((item) => {
      ...
      const activeClasses = "bg-blue-600 text-white font-semibold"; // New active style

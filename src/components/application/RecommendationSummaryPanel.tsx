          ...
          {disView.llm_summary && (
            <div className="mb-4">
              <h3 className="text-sm font-semibold mb-2 text-gray-700 flex items-center">
                ...
                Case Summary
                <Badge variant="outline" className="ml-2 px-1.5 py-0 text-[10px] font-medium text-purple-700 bg-purple-50 border-purple-200">
                  AI-generated
                </Badge>
              </h3>
              <div
                data-testid="recommendation-summary-letter"
                className="p-3 border rounded-md bg-gray-50/80 text-xs text-gray-700 leading-relaxed whitespace-pre-line"
              >
                {disView.llm_summary}
              </div>
              <p className="text-[11px] text-gray-500 mt-1.5">
                This narrative was generated by AI to assist review. It is not a decision — the deciding
